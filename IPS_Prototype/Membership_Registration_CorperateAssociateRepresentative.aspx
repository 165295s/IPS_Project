...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div class="form-group">
      ...
      <label for="Honorific">Honourific</label>
        ...
        <div class="form-group">
            <input type="text" class="form-control" onkeyup="SearchText()" runat="server" id="txtFirstName" style="width: 350px;" />
        </div>
                ...
                <!--Content goes here -->
                    ...
                    <div style="float: left; margin-top:-5px;">
                        ...
                        <div class="form-group">
                         ...
                         <button type="button" id="updatePA" runat="server" class="btn btn-primary" onclick="RowEditing" style="width: 150px; height: 40px;">Update</button>
                        </div>
...
<%--            <button  ID="btnDel" class="btn btn-primary"  OnClick="RowEditing" Style="height: 30px; padding-top: 3px;">Update</button>--%>
