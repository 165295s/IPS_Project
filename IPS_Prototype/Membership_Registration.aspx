...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function disableDateTime() {
            $("#ContentPlaceHolder1_datetime").val("adasdasdadas");
            $("#ContentPlaceHolder1_hiddentext").val("");
            $("#ContentPlaceHolder1_datetime").prop('disabled', true).val("");
...
<%--            <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>--%>
            <%--            <label for="Result" id="lblresult" runat="server"></label>--%>
        </div>
    </div>
</asp:Content>
