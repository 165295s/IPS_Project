...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <strong>Unsuccessful!</strong> There seems to be an error! Please notify the Administrators.
    ...
    <label class="title">Events Management</label>
        ...
        <asp:GridView runat="server" ID="EventTable" CssClass="table table-hover BlueTable" EmptyDataText="No Records Found" AutoGenerateColumns="false" AutoGenerateEditButton="false" AutoGenerateDeleteButton="false" GridLines="None" UseAccessibleHeader="true" BorderStyle="None">
           <Columns>
