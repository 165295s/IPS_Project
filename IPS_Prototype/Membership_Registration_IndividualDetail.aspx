...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function hidelblHidden() {
            $('lblHidden').css('display', 'none');
            $('lblShow').css('display', 'block');
        }
        function showlblShow() {
            $('lblHidden').css('display', 'block');
            $('lblShow').css('display', 'show');
        }
    </script>
</asp:Content>
    ...
    <div class="collapse" id="UserRegister">
        ...
        <div class="form-group">
            <input type="text" class="form-control" runat="server" id="txtFullName" style="width: 350px;" />
                    ...
                    <div class="form-group" style="float: left; margin-top: 128px;">
                        ...
                        <button type="button" id="btnClear" class="btn btn-primary" onclick="clearFields();" style="width: 150px; height: 40px; ">
                            Clear
                        </button>
                    ...
                    <div>
                        <label  id="lblHidden" for="UserTable" style="font-weight: bold;">Personal Assistant:</label>
                    </div>
                ...
                <div class="right_div" style="float: left; margin-top: -27px; margin-left: 29px;">
...
<%--                    <asp:GridView runat="server" EnableViewState="false" ID="UserTable" ShowHeaderWhenEmpty="true" DataKeyNames="PA_ID" OnRowDeleting="RowDeleting" EmptyDataText="No Records Found" CssClass="table table-hover BlueTable" AutoGenerateColumns="false" AutoGenerateEditButton="false" AutoGenerateDeleteButton="false" GridLines="None" UseAccessibleHeader="true" >--%>
                            <asp:GridView CssClass="table table-hover BlueTable" ID="UserTable" runat="server" EmptyDataText="No Records Found" ShowHeaderWhenEmpty="true" OnRowDeleting="RowDeleting" AutoGenerateColumns="false" GridLines="None" UseAccessibleHeader="true" BorderStyle="None">
